...
from tensorflow_federated.python.common_libs import async_thread_runner
...
class ThreadDelegatingExecutorValue(evb.ExecutorValue):
  ...
  def __init__(self, value: evb.ExecutorValue,
               async_runner: async_thread_runner.AsyncThreadRunner):
    self._value = value
...
class ThreadDelegatingExecutor(eb.Executor):
  ...
  def __init__(self, target_executor: eb.Executor):
    ...
    self._async_runner = async_thread_runner.AsyncThreadRunner()
